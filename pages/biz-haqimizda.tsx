                        ...
                        <Col xs={24} sm={12} md={12} lg={12}>
                            <div className={"mt-24"}>
                                <h1 className={"text-[40px] font-bold"}>
                                    Привет, друзья
                                    <br />
                                    мы хотим вместе начать курс <br />{" "}
                                    веб-дизайна. Вам тоже нравится ?
                                </h1>
                                <span
                                    className={"text-gray-400 text-[20px] mb-3"}
                                >
                                    Выберите нужные вам курсы из категорий
                                    онлайн или очных курсов, <br /> получите
                                    индивидуальную помощь от инструкторов и{" "}
                                    <br /> освойте новые навыки.
                                </span>
                            </div>
                        </Col>
                    </Row>
                        ...
                        <Col xs={24} sm={12} md={12} lg={12}>
                            <div className={"pt-5 mb-5"}>
                                <h1 className={"font-bold text-2xl"}>
                                    Узнайте о последних курсах из
                                    информационного <br /> бюллетеня
